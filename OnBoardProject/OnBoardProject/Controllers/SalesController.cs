...
namespace OnBoardProject.Controllers
{
    ...
    public class SalesController : ControllerBase
    {
        ...
        {
            var sales = await _context.Sales.Include(s => s.Customer).Include(s => s.Product).
                Include(s => s.Store).FirstOrDefaultAsync(s => s.Id == id);
        ...
        {
            Console.WriteLine(sales.DateSold);
